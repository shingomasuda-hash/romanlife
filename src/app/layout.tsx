...
export const metadata: Metadata = {
  ...
  description:
    'マールブランシュを展開する株式会社ロマンライフの2028年卒向けオープン・カンパニー。業界紹介、販売職体験ワーク、社員座談会、社内見学を通して、仕事と会社のリアルを体験できます。2026年8月31日・9月4日、京都本社で開催。',
  keywords: [
    'ロマンライフ',
    'マールブランシュ',
    'オープン・カンパニー',
  ...
  openGraph: {
    ...
    description:
      '2028年卒向けオープン・カンパニー。販売職体験ワーク、社員座談会、社内見学。2026年8月31日（月）・9月4日（金）京都本社で開催。',
    images: [
      {
        url: '/ogp.png',
        width: 1200,
        height: 630,
        alt: 'ロマンライフ オープン・カンパニー 2028年卒向け 2026年8月31日・9月4日 京都本社開催',
      },
    ],
  },
  twitter: {
    ...
    title:
      'お菓子の先にある、しあわせを届ける仕事。｜ロマンライフ オープン・カンパニー',
    description:
      '2028年卒向けオープン・カンパニー。2026年8月31日（月）・9月4日（金）京都本社で開催。',
    images: ['/ogp.png'],
  },
